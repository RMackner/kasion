...
#
%changelog
* Sat Oct 15 2022 Jan DrÃ¶gehoff <sentrycraft123@gmail.com> - 5.19.15-202.fsync
...
- redhat/configs/fedora: Make PowerPC's nx-gzip buildin (Jakub ÄŒajka)

* Fri Jul 29 2022 Fedora Kernel Team <kernel-team@fedoraproject.org> [5.19.0-0.rc8.6e2c0490769e.61]
- omit unused Provides (Dan HorÃ¡k)
...
- kabi: Add kABI macros for enum type (ÄŒestmÃ­r Kalina) [2024595]
- kabi: expand and clarify documentation of aux structs (ÄŒestmÃ­r Kalina) [2024595]
- kabi: introduce RH_KABI_USE_AUX_PTR (ÄŒestmÃ­r Kalina) [2024595]
- kabi: rename RH_KABI_SIZE_AND_EXTEND to AUX (ÄŒestmÃ­r Kalina) [2024595]
- kabi: more consistent _RH_KABI_SIZE_AND_EXTEND (ÄŒestmÃ­r Kalina) [2024595]
- kabi: use fixed field name for extended part (ÄŒestmÃ­r Kalina) [2024595]
- kabi: fix dereference in RH_KABI_CHECK_EXT (ÄŒestmÃ­r Kalina) [2024595]
- kabi: fix RH_KABI_SET_SIZE macro (ÄŒestmÃ­r Kalina) [2024595]
- kabi: expand and clarify documentation (ÄŒestmÃ­r Kalina) [2024595]
- kabi: make RH_KABI_USE replace any number of reserved fields (ÄŒestmÃ­r Kalina) [2024595]
- kabi: rename RH_KABI_USE2 to RH_KABI_USE_SPLIT (ÄŒestmÃ­r Kalina) [2024595]
- kabi: change RH_KABI_REPLACE2 to RH_KABI_REPLACE_SPLIT (ÄŒestmÃ­r Kalina) [2024595]
- kabi: change RH_KABI_REPLACE_UNSAFE to RH_KABI_BROKEN_REPLACE (ÄŒestmÃ­r Kalina) [2024595]
- kabi: introduce RH_KABI_ADD_MODIFIER (ÄŒestmÃ­r Kalina) [2024595]
- kabi: Include kconfig.h (ÄŒestmÃ­r Kalina) [2024595]
- kabi: macros for intentional kABI breakage (ÄŒestmÃ­r Kalina) [2024595]
- kabi: fix the note about terminating semicolon (ÄŒestmÃ­r Kalina) [2024595]
- kabi: introduce RH_KABI_HIDE_INCLUDE and RH_KABI_FAKE_INCLUDE (ÄŒestmÃ­r Kalina) [2024595]
...
- rtw89: enable new driver rtw89 and device RTK8852AE (ÃÃ±igo Huguet)
...
- mt76: enable new device MT7921E in CentOs/RHEL (ÃÃ±igo Huguet) [2004821]
...
- kernel.spec: Add kernel{,-debug}-devel-matched meta packages (TimothÃ©e Ravier)
...
- all: s390x: Increase CONFIG_PCI_NR_FUNCTIONS to 512 (#1888735) (Dan HorÃ¡k)
...
- kernel.spec: don't override upstream compiler flags for ppc64le (Dan HorÃ¡k)
- Fedora config updates (Justin M. Forbes)
...
- enable PROTECTED_VIRTUALIZATION_GUEST for all s390x kernels (Dan HorÃ¡k)
